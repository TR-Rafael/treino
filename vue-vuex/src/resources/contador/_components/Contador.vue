<template>
    <div>
        ...
        <h2 class="font-weight-light">Contador (global do Vuex): {{ contador }}</h2>
        <h4 class="font-weight-light">Contador chamado com (Alias): {{ contadorAlias }}</h4>
        <h4 class="font-weight-light">Contador x 2 (local): {{ contadorMultiplicado }}</h4>
